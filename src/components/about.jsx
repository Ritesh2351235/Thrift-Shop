...
<div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
  ...
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    <div className="mx-auto max-w-2xl lg:mx-0">
      ...
      <p className="mt-6 text-lg leading-8 text-gray-300">Our thrift shop champions sustainability by curating a diverse selection of pre-loved items, fostering a culture of conscious consumption, and promoting a circular economy for a greener future</p>
    </div>
